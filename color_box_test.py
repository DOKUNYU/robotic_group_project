...
#lego_Uid = p.loadURDF("lego/lego.urdf",np.array([0.3, 0, 0.01]))
...
time_step = 1./50. #原来是1/240 为了变快改了1/50的step
...
while True:
    ...
    ee_pose_cartesian = p.getLinkState(pandaUid,11,computeForwardKinematics=1)[:1][0]#link index=11?
    ...
    target_pos = base_pos + 0.1*tz_vec  #camera init downward?
